    ...
    if (companies.length === 0) {
      return (
        <EmptyState
          ...
          action={t("dashboard.welcome.cta")}
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <p className="text-sm font-medium text-red-50">
                    {data.budgets.activeIncidents} {data.budgets.activeIncidents === 1 ? t("dashboard.activeBudgetIncident") : t("dashboard.activeBudgetIncidents")}
                  </p>
