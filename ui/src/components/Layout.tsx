            ...
            <div className="border-t border-r border-border px-3 py-2 bg-background">
              <div className="flex items-center gap-1">
                ...
                <Button
                  ...
                  onClick={toggleTheme}
                  aria-label={nextTheme === "dark" ? t("layout.switchToDark") : t("layout.switchToLight")}
                  title={nextTheme === "dark" ? t("layout.switchToDark") : t("layout.switchToLight")}
                >
                ...
                <Button
                  ...
                  variant="ghost"
                  size="icon-sm"
                  className="text-muted-foreground shrink-0 text-[11px] font-semibold px-1.5 min-w-0"
